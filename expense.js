function  addExpense(e)
{
    ...
    axios.post("https://expensetracker0108.herokuapp.com/addExpense",expenseDetails ,{headers:{"Authorization":token}})
    .then((response)=>{
 ...
 
{
   ...
   const token = localStorage.getItem('token')
        axios.get("https://expensetracker0108.herokuapp.com/getdetails", {headers:{"Authorization":token}})
        .then((response)=>{
            console.log(response)
...
function deleteUser(id) {
    const token = localStorage.getItem('token')
    axios.delete(`https://expensetracker0108.herokuapp.com/deleteInfo/${id}`, {headers:{"Authorization":token}})
    .then((respone)=>{
...
const logout = document.getElementById('logout')
 ...
 document.getElementById('rzp-button1').onclick = async function (e) {
    const token = localStorage.getItem('token')
    const response  = await axios.get('https://expensetracker0108.herokuapp.com/purchase', { headers: {"Authorization" : token} });
    console.log(response);
    var options =
    {
     ...
     "handler": function (response) {
         console.log(response);
         axios.post('https://expensetracker0108.herokuapp.com/updatepurchase',{
